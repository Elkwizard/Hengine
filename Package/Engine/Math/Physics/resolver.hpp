...
class CollisionResolver {
	private:
		...
		Vector normalImpulses(double vAB1, double vAB2, double mA, double mB, double iA, double iB, double e, const Vector& n, double rA1x, double rA1y, double rB1x, double rB1y, double rA2x, double rA2y, double rB2x, double rB2y);
