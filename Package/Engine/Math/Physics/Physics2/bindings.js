HengineWASMResource.imports["Physics2"] = ["__global_printStringJS0","__global_sendJSArgument1","__global_runJS2","__global_triggerRule4","__global_collisionRule5","__global_onCollide6"];
HengineWASMResource.bindings["Physics2"] = (module, imports, exports) => {
	...
	Object.defineProperty(module, "onCollide", {
		set(_fn) {
			imports.__global_onCollide6 = (_0, _1, _2, _3, _4, _5) => _fn(cast(module.RigidBody, _0), cast(module.RigidBody, _1), cast(module.VectorN_2_, _2), cast(module.Array_VectorN_2__0, _3), !!_4, !!_5);
		}
	});
	
	module.Orientation = class Orientation extends Binding {
		static CONST_PROPERTIES = [];
		get rotation() { return exports._Orientation_getRotation7(this.pointer); }
		set rotation(_rotation) { exports._Orientation_setRotation8(this.pointer, _rotation); }
	};
	
	module.Transform = class Transform extends Binding {
		static CONST_PROPERTIES = ["linear","orientation"];
		get linear() { return cast(module.VectorN_2_, exports._get_Transform_linear9(this.pointer)); }
	...
	module.Polytope = class Polytope extends module.Shape {
		static CONST_PROPERTIES = [];
		static create(_vertices) { return exports._Polytope_Polytope13(_vertices.pointer); }
	...
	module.RigidBody = class RigidBody extends Binding {
		...
		get prohibitedDirections() { return cast(module.Array_VectorN_2__0, exports._RigidBody_getProhibitedDirections29(this.pointer)); }
		...
		get inertia() { return exports._RigidBody_getInertia35(this.pointer); }
	...
	module.VectorN_2_ = class VectorN_2_ extends Binding {
		static CONST_PROPERTIES = [];
		static create() { return exports._VectorN_2__VectorN65(); }
		delete() { exports._delete_VectorN_2__VectorN65(this.pointer); }
		get(index) { return exports._VectorN_2__get66(this.pointer, index); }
		set(index, value) { exports._VectorN_2__set67(this.pointer, index, value); }
		setAll(x, y) { exports._VectorN_2__setAll68(this.pointer, x, y); }
		static build(x, y) { return cast(module.VectorN_2_, exports._VectorN_2__build69(x, y)); }
	};
	
	module.Array_VectorN_2__0 = class Array_VectorN_2__0 extends Binding {
		static CONST_PROPERTIES = [];
		get length() { return exports._get_Array_VectorN_2__0_length70(this.pointer); }
		static create(_length) { return exports._Array_VectorN_2__0_Array_VectorN_2__071(_length); }
		delete() { exports._delete_Array_VectorN_2__0_Array_VectorN_2__071(this.pointer); }
		get(index) { return cast(module.VectorN_2_, exports._Array_VectorN_2__0_get72(this.pointer, index)); }
		set(index, value) { exports._Array_VectorN_2__0_set73(this.pointer, index, value.pointer); }
	};
	
	module.Array_ConstraintDescriptor_1 = class Array_ConstraintDescriptor_1 extends Binding {
		static CONST_PROPERTIES = [];
		get length() { return exports._get_Array_ConstraintDescriptor_1_length74(this.pointer); }
		static create(_length) { return exports._Array_ConstraintDescriptor_1_Array_ConstraintDescriptor_175(_length); }
		delete() { exports._delete_Array_ConstraintDescriptor_1_Array_ConstraintDescriptor_175(this.pointer); }
		get(index) { return cast(module.ConstraintDescriptor, exports._Array_ConstraintDescriptor_1_get76(this.pointer, index)); }
		set(index, value) { exports._Array_ConstraintDescriptor_1_set77(this.pointer, index, value.pointer); }
	};
