const objectUtils = {
	...
	defineBuiltin(obj, key, value) {
		Object.defineProperty(obj, key, { value, enumerable: false });
	},
	defineBuiltinAccessor(obj, key, get, set) {
		Object.defineProperty(obj, key, { get, set, enumerable: false });
	},
 ...
 */
objectUtils.defineBuiltinAccessor(Array.prototype, "last", function () {
 ...
 */
objectUtils.defineBuiltin(Array.prototype, "pushArray", function (arr) {
 ...
 * @return Number
 */
objectUtils.defineBuiltin(Array.prototype, "argmax", function (metric = x => x) {
...
objectUtils.defineBuiltin(Array.prototype, "argmin", function (metric = x => x) {
	return this.argmax(x => -metric(x));
});
objectUtils.defineBuiltin(Array.prototype, "flatten", function () {
	return this;
});
 ...
 * @return Number 
 */
objectUtils.defineBuiltin(Number.prototype, "toDegrees", function () {
 ...
 * @return Number
 */
objectUtils.defineBuiltin(Number.prototype, "toRadians", function () {
 ...
 * @return String
 */
objectUtils.defineBuiltin(String.prototype, "capitalize", function () {
 ...
 * @return String[2]
 */
objectUtils.defineBuiltin(String.prototype, "cut", function (char) {
 ...
 * @return Promise
 */
objectUtils.defineBuiltin(String.prototype, "download", function (name = "string", ext = "txt") {
...
objectUtils.defineBuiltin(String.prototype, "trimIndentation", function () {
...
objectUtils.defineBuiltin(String.prototype, "set", function (index, character) {
 ...
 * @return String
 */
objectUtils.defineBuiltin(String.prototype, "indent", function () {
	return this.split("\n").map(str => "\t" + str).join("\n");
});
objectUtils.defineBuiltin(String.prototype, "inverseMatchAll", function (regex) {
...
(() => {
	...
	objectUtils.defineBuiltin(Object.prototype, "toString", function (depth = 0) {
		if (depth < 0) {
...
objectUtils.defineBuiltin(Array.prototype, "toString", Object.prototype.toString);
...
{ // local storage
	 ...
	 */
	objectUtils.defineBuiltin(Storage.prototype, "downloadBackup", function (file = "backup") {
		const a = document.createElement("a");
	 ...
	 * @return Boolean
	 */
	objectUtils.defineBuiltin(Storage.prototype, "clear", function (file) {
	 ...
	 */
	objectUtils.defineBuiltin(Storage.prototype, "uploadBackup", function () {
...
{ // webgl
	function overrideGetContext(CanvasType) {
		...
		objectUtils.defineBuiltin(CanvasType.prototype, "getContext", function (name, options) {
			if (name === "webgl2" && !window.WebGL2RenderingContext) {
				...
				objectUtils.defineBuiltin(context, "vertexAttribDivisor", instancing.vertexAttribDivisorANGLE.bind(instancing));
				objectUtils.defineBuiltin(context, "drawArraysInstanced", instancing.drawArraysInstancedANGLE.bind(instancing));
				objectUtils.defineBuiltin(context, "drawElementsInstanced", instancing.drawElementsInstancedANGLE.bind(instancing));

				// shader transpilation
				const { shaderSource } = WebGLRenderingContext.prototype;
				objectUtils.defineBuiltin(context, "shaderSource", function (shader, source) {
