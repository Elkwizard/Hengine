const HG = {};
HG.reference = (a, b, k) => {
	Object.defineProperty(b, k, { get: () => a[k], set: v => a[k] = v });
};
HG.file = file => {
	const exports = file();
	for (const k in exports) HG.reference(exports, HG.exports, k);
};
HG.privateFile = file => {
	const exports = file();
	for (const k in exports) HG.reference(exports, HG.private, k);
};
HG.private = { };
HG.exports = window;
HG.file(() => {
