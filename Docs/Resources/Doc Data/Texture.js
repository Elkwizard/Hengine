load(String.raw`
	...
	**(/p)
	...
	(p)
		...
		(/method)
		(method:Texture.fromRenderer@renderer, x, y, width, height | renderer, region@$Texture$)
			Returns a Texture representation of the pixels within the specified region in the given #Renderer#.
			(2)Parameters(/2)
			(p2)
